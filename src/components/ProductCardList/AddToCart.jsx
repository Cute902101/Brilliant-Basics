    ...
    <div>
      ...
      <div className="p-2 mb-10">
        <button
          ...
          className="relative p-1 shadow-lg cursor-pointer bg-black text-white text-[14px] rounded w-[150px] h-10"
        >
          Add To Cart
          {/* Div for sliding button effect */}
          <div
            className={`absolute top-0 left-0 bg-[#a9a9a9] w-20 h-10 opacity-0 ${
